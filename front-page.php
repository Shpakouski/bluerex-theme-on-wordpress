...
<header class="main-header">
    <nav class="navbar navbar-expand-lg">
        <a class="navbar-brand" href="#">
            <img src="<?php bloginfo('template_url'); ?>/assets/img/logo.png" alt="BlueRex Company">BlueRex
        </a>
    ...
    <div class="main-header-text">
        ...
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Asperiores dignissimos aliquid, blanditiis
            officia repellat voluptates?</p>
